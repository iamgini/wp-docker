 ...
 */
class Infinity_Mag_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Infinity_Mag_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Infinity_Mag_Customize_Section_Upsell extends WP_Customize_Section {
